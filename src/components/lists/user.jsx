        ...
        <div className="card-content">
            ...
            <ul>
                ...
                {props.current.role === "admin"
                    &&
                    <div>
                     {user.countries  === "" ||  <li><h5>countrie: {user.countries}</h5></li>}   
                     {user.address === "" ||<li><h5>address: {user.address}</h5></li> }  
                      {user.birthday === "" || <li><h5>birthday: {user.birthday}</h5></li>}  
        ...
        <div className="card-content">
            ...
            {currentUser ? <button className="waves-effect waves-light btn activator ">More detail</button> :
                <span>
                    ...
                    {check(arr) ? <span>   <button className="waves-effect grey btn" onClick={() => dispatch(unFollow(user._id, props.page, props.current.id, searchResult))} >unsubscribe</button> </span> :
                        <span>  <button className="waves-effect green btn" onClick={() => dispatch(followUser(user._id, props.page, props.current.id, searchResult))} > Subscribe </button>  </span>
                    }</span>}
        </div>
